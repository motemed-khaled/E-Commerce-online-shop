export class Products{
    ...
    getHtmlFeaturedProducts()
   {
    let htmlFeaturedProducts="";
    return htmlFeaturedProducts= ` 
...
writeHtmlFeaturedProducts(data)
{
document.querySelector('.container-fluid.pt-5.pb-3 .row.px-xl-5').innerHTML=data;
}
}
